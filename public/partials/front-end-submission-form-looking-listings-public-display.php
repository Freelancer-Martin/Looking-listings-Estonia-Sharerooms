...
function yourprefix_frontend_form_register() {
	...
	$cmb->add_field( array(
		'name'    => __( 'New Rental Listing Title', 'YOURTEXTDOMAIN' ),
...
*/	
	$cmb->add_field( array(
		...
		'desc'       => __( 'Please enter your name.', 'YOURTEXTDOMAIN' ),
		'id'         => 'submitted_author_name',
		'type'       => 'text',
	) );
	$cmb->add_field( array(
		'default_cb' => 'yourprefix_maybe_set_default_from_posted_values',
		'name'       => __( 'Phone', 'YOURTEXTDOMAIN' ),
		'desc'       => __( 'Please enter your Phone.', 'YOURTEXTDOMAIN' ),
		'id'         => 'submitted_number',
		'type'       => 'text',
	) );
	$cmb->add_field( array(
		'default_cb' => 'yourprefix_maybe_set_default_from_posted_values',
		'name'       => __( 'Address',  'YOURTEXTDOMAIN' ),
		'desc'       => __( 'Please enter your address' ),
		'id'         => 'submitted_address',
		'type'       => 'textarea',
	) );
	$cmb->add_field( array(
		'default_cb' => 'yourprefix_maybe_set_default_from_posted_values',
		'name'       => __( 'Occupation',  'YOURTEXTDOMAIN' ),
		'desc'       => __( 'Please enter your occupation' ),
		'id'         => 'submitted_occupation',
		'type'       => 'text',
	) );
	$cmb->add_field( array(
		'default_cb' => 'yourprefix_maybe_set_default_from_posted_values',
		'name'       => __( 'Your Email', 'YOURTEXTDOMAIN' ),
		'desc'       => __( 'Please enter your e-mail', 'OURTEXTDOMAIN' ),
		'id'         => 'submitted_author_email',
		'type'       => 'text_email',
	) );
	$cmb->add_field( array(
		'default_cb' => 'yourprefix_maybe_set_default_from_posted_values',
		'name'       => __( 'New Rental Description', 'YOURTEXTDOMAIN' ),
	...
	$cmb->add_field( array(
		'default_cb' => 'yourprefix_maybe_set_default_from_posted_values',
		'name'       => __( 'Featured Image', 'YOURTEXTDOMAIN' ),
	...
	$cmb->add_field( array(
		...
		'id'               => 'submitted_how_many_human',
		'type'             => 'select',
		'show_option_none' => true,
		'default'          => 'custom',
		'options'          => array(
			'I_am' => __( 'I am', 'cmb2' ),
			'We_are'   => __( 'We are', 'cmb2' ),
...
/*
	...
	update_post_meta ( $new_submission_id, 'submitted_author_name', $_POST[ 'submitted_author_name' ] );
	update_post_meta ( $new_submission_id, 'submitted_number', $_POST[ 'submitted_number' ] );
	...
	update_post_meta ( $new_submission_id, 'submitted_post_content', $_POST[ 'submitted_post_content' ] );
	update_post_meta ( $new_submission_id, 'submitted_how_many_human', $_POST[ 'submitted_how_many_human' ] );
	update_post_meta ( $new_submission_id, 'submitted_occupation', $_POST[ 'submitted_occupation' ] );
